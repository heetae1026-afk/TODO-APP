...
- All items pass on first validation pass. No [NEEDS CLARIFICATION] markers were needed —
  reasonable defaults were documented in the Assumptions section (single user, no auth,
  no title editing, no due dates/priority/tags, creation-order sorting, permanent delete).
